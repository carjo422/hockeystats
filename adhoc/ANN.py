...
c.execute("SELECT OFF_SCORE_HOME, DEF_SCORE_HOME, OFF_SCORE_AWAY, DEF_SCORE_AWAY, OUTCOME1X2, OUTCOME45 FROM GOALS_FOREST_TABLE_1 WHERE GAMEDATE > ? AND SEASONID < ?",['2015-10-15',2019])
